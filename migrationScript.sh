...
connectionString=$(jq '.ConnectionStrings.DefaultConnection' ./WebGUI/appsettings.json)
...
dotnet ef -s ../WebGUI migrations add "Init"

dotnet ef -s ../WebGUI database update
